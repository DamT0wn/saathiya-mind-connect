...
export function FirebaseAuth() {
  const { signInWithGoogle, signInWithEmail, signUpWithEmail, sendEmailLink } = useAuth();
  ...
  const handleEmailLinkSignIn = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await sendEmailLink(emailLinkEmail);
      toast({
        title: "Email sent!",
  ...
  return (
    <div className="flex items-center justify-center min-h-[600px] p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>Welcome to Saathi</CardTitle>
          <CardDescription>Sign in to access your mental wellness companion</CardDescription>
        </CardHeader>
        <CardContent>
